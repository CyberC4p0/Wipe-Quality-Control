...
function title()
{
	clear
	echo -ne "\033[1;33m
 _  _ _   _ _____  __ __      ___              ___            _ _ _           ___         _           _   _____         _ 
| || | | | | _ ) \/ / \ \    / (_)_ __  ___   / _ \ _  _ __ _| (_) |_ _  _   / __|___ _ _| |_ _ _ ___| | |_   _|__  ___| |
| __ | |_| | _ \>  <   \ \/\/ /| | '_ \/ -_) | (_) | || / _' | | |  _| || | | (__/ _ \ ' \  _| '_/ _ \ |   | |/ _ \/ _ \ |
|_||_|\___/|___/_/\_\   \_/\_/ |_| .__/\___|  \__\_|__,_\__,_|_|_|\__|\_, |  \___\___/_||_\__|_| \___/_|   |_|\___/\___/_|
				  |_|                                  |__/                                                
	\e[0m"
}
...
disk=$(lsblk -ndpo NAME,SIZE,TRAN,ROTA,SERIAL | grep -w 'nvme\|sata\|mmcblk0' | awk -v row="$row" 'NR >= row && NR <= row')
...
if [ "$disk_transport_bus" == "sata" ]; then
...
elif [ "$disk_transport_bus" == "nvme" ]; then
	disk_type="NVMe"
else
	disk_type="eMMC"
	disk_serial_number="$computer_serial_number"
	disk_transport_bus="Soldered/Integrated"
fi
